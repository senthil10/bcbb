...
# Fetch version from git tags, and write it in version.py to allow introspection
version_py = os.path.join(os.path.dirname(__file__), 'bcbio', 'pipeline', 'version.py')
version_git = subprocess.check_output(["git", "describe"]).rstrip()

version_msg = "# Do not edit this file, pipeline versioning is governed by git tags"
version = open(version_py, 'w').write(version_msg + os.linesep + "__version__=" + version_git)
